...
function against a baseline agent uscoresing alpha-beta search and iterative
deepening (ID) called `AB_Improved`score. The `AB_Custom` agent uses
ID and alpha-beta search with the custom_score function defined in
game_agent.py.
"""
